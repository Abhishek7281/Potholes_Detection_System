...
def main():
    ...
    # Custom CSS for cursor changes
    st.markdown(
        """
        <style>
        /* Change cursor to pointer (hand) when hovering over the drag-and-drop area */
        div[data-testid="stFileDropzone"] {
            cursor: pointer !important;
        }
        /* Change cursor to pointer (hand) when hovering over the Browse button */
